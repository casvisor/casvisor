  ...
  renderImage() {
    return (
      <Card size="small" title={
        ...
        <Row style={{marginTop: "20px"}}>
          ...
          <Col span={22} >
            <Select virtual={false} style={{width: "100%"}} value={this.state.image.category} onChange={value => {
              this.updateImageField("state", value);
            }}
            options={[
        ...
        <Row style={{marginTop: "20px"}}>
          <Col style={{marginTop: "5px"}} span={(Setting.isMobile()) ? 22 : 2}>
            {Setting.getLabel(i18next.t("image:State"), i18next.t("image:State - Tooltip"))} :
          </Col>
          <Col span={22} >
            <Select virtual={false} style={{width: "100%"}} value={this.state.image.state} onChange={value => {
              this.updateImageField("state", value);
            }}
            options={[
        ...
        <Row style={{marginTop: "20px"}}>
          ...
          <Col span={22}>
            <Input
              value={this.state.image.startupMode}
              onChange={(e) => {
                this.updateImageField("startupMode", e.target.value);
              }}
            />
          </Col>
        </Row>
